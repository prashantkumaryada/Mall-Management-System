...
namespace MallRAj.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerName,CustomerPhoneNumber")] CustomerModel customerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerName,CustomerPhoneNumber")] CustomerModel customerModel)
        {
